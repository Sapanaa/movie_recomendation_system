...
DF_PATH = os.path.join(BASE_DIR, "pickle/df.pkl")
INDICES_PATH = os.path.join(BASE_DIR, "pickle/indices.pkl")
TFIDF_MATRIX_PATH = os.path.join(BASE_DIR, "pickle/tdidf_matrix.pkl")
TFIDF_PATH = os.path.join(BASE_DIR, "pickle/tfidf.pkl")
